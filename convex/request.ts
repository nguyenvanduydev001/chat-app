...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (args.email === identity.email) {
      throw new ConvexError("Không thể gửi yêu cầu cho chính bạn");
    }
    ...
    if (!receiver) {
      throw new ConvexError("Người nhận không tìm thấy");
    }
    ...
    if (requestAlreadySent) {
      throw new ConvexError("Yêu cầu đã được gửi");
    }
    ...
    if (requestAlreadyReceiver) {
      throw new ConvexError("Người dùng này đã gửi yêu cầu");
    }
    ...
    if (
      ...
      throw new ConvexError("Bạn đã là bạn bè với người dùng này");
    }
...
export const deny = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (!request || request.receiver !== currentUser._id) {
      throw new ConvexError("Đã xảy ra lỗi khi từ chối yêu cầu này");
    }
